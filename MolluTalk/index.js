import charface from './JSON/MT-CharFace.json' assert {type:'json'};///差分表情列表
	...
	[405],
	{
			...
			var eF = function(e)
				...
				eY = function(e)
				{
					...
					if(cfemoji != 'NO'){let cf = cfemoji;cfemoji = 'NO';//@加入判断
						...
						if(cf == 'CharFace' && charface[cfindex])
						{
		...
		83: function(e, n, t)
		{
			...
			var r = t(9521),
				...
				})(["max-width:40%;border:2px solid ", ";background-color:transparent;padding:0.5rem;border-radius:10px;"], function(e)
