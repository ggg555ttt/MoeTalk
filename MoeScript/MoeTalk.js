...
$(".frVjsk").wait(function()
{
	...
	$(".frVjsk").append(`<a href='${href}${browser.isMobile ? 'Setting' : 'Editor'}.html?${version}'><button class='${class0}'><b style='color:black;'>設</b></button></a><span class='tool'>设置页面</span><br>`);
},".frVjsk")
//使用说明
